...
PALETTE_1 = ["#158BFA", "#19BE0A", "#D5099B", "#08BDB4", "#E11603"]
PALETTE_2 = ["#B4E80A", "#3C52F2", "#EE1127", "#42F30C", "#9D28E6"]
PALETTE_3 = ["#11ABE8", "#3FE7C8", "#EFF323", "#E73434", "#1484ED"]
...
- **Young adults with children** and **lower income** may require enhanced affordability verification.
- Those **living with parents** might indicate dependency vs independence—use caution in co-signed vs solo applications.
- **High-risk occupations** (e.g., seasonal jobs) may benefit from tailored evaluation or scoring adjustments.
""")
