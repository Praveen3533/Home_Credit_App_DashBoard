...
PALETTE = ["#58F110", "#139AEE", "#C006AD", "#D30A0A", "#08D0D0"] 
...
st.write("""
- Most applicants belong to low-to-mid income ranges, with highly skewed income and credit distributions.
- High DTI and LTI ratios indicate stronger repayment stress and higher default likelihood.
- Non-defaulters earn more and access larger credits compared to defaulters.
- Default risk is highest in the Low income bracket and decreases with higher income.
- Income, credit, and annuity are strongly correlated, but affordability ratios matter more for default prediction.
""")
