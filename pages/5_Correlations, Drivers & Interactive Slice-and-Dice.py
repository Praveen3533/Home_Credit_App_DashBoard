...
fig_corr_bar = px.bar(
    ...
    color_discrete_sequence=[
        "#2265DA", "#E91212", "#006400", "#9411F1", "#38BBBB",
        "#FF8C00", "#A40606", "#4128E0", "#9FF40D", "#8B008B"
    ],
    height=400
)
...
figs.append(px.bar(df_g, x="CODE_GENDER", y="TARGET", title="Default Rate by Gender", labels={"TARGET":"Default Rate"}, color="CODE_GENDER",color_discrete_map={"M": "#0c48ee", "F": "#f705e3"}).update_yaxes(tickformat=".0%"))

df_e = filtered_df.groupby("NAME_EDUCATION_TYPE")["TARGET"].mean().reset_index()
figs.append(px.bar(df_e, x="NAME_EDUCATION_TYPE", y="TARGET", title="Default Rate by Education", labels={"TARGET":"Default Rate"},color="NAME_EDUCATION_TYPE",
        color_discrete_sequence=["#89CFF0", "#FFB6C1", "#90EE90", "#FFD700", "#D8BFD8"]).update_yaxes(tickformat=".0%"))
